<x-app-layout>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900">Add Software</h1>
            <p class="mt-2 text-sm text-gray-700">Create a new software entry in your inventory system.</p>
        </div>
    </div>

    <div class="mt-8">
        <form action="{{ route('software.store') }}" method="POST" class="space-y-6">
            @csrf
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="notes" name="notes" rows="3"
                                    class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
